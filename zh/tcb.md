...
- 云开发服务使用 **预付费** 模式，当你的服务使用超过服务商的免费部分，且账户余额不足时，会停止服务。这时候你需要在 Cocos 开发者账户中心进行 **预充值**。具体内容可参考 [计费说明](./about-billing.md)。
...
**如何在 Cocos Creator 中开通腾讯云TCB服务？**
https://www.bilibili.com/video/BV1CC4y1p7r7

## FAQ

- Q：开发者在 Cocos 删除部分不需要的游戏后，其他线上游戏的 TCB 云开发功能无法正常使用，在腾讯云后台显示环境为已隔离状态。
  A：由于腾讯的云开发逻辑是一个游戏下可以建立多个环境，Cocos 侧无法做一一映射，所以目前在游戏删除时采取都关闭的逻辑。请在服务面板中所需要使用的游戏的 TCB 云开发面板先点击关闭，再重新开通。
...
- [使用了云开发，如何发布到头条小游戏](https://forum.cocos.org/t/topic/102627)
